...
namespace sead {
    ...
    public:
        ...
        DelegateBase(T* instance, PTMF fn)
            : mInstance(instance)
            , mFunctionPtr(fn) { }
    ...
    public:
        DelegateBase() = default;
        explicit DelegateBase(FunctionPointer fn)
            : mFunctionPtr(fn) { }
    ...
    public:
        explicit LambdaDelegate(Lambda l)
            : mLambda(std::move(l)) { }
    ...
    public:
        explicit LambdaDelegateR(Lambda l)
            : mLambda(std::move(l)) { }
        auto invoke() override { return mLambda(); }
        auto operator()() const { return mLambda(); }
    ...
    public:
        explicit LambdaDelegate1(Lambda l)
            : mLambda(std::move(l)) { }
    ...
    public:
        explicit LambdaDelegate1R(Lambda l)
            : mLambda(std::move(l)) { }
        auto invoke(A1 a1) override { return mLambda(a1); }
        auto operator()(A1 a1) const { return mLambda(a1); }
    ...
    public:
        explicit LambdaDelegate2(Lambda l)
            : mLambda(std::move(l)) { }
    ...
    public:
        explicit LambdaDelegate2R(Lambda l)
            : mLambda(std::move(l)) { }
        auto invoke(A1 a1, A2 a2) override { return mLambda(a1, a2); }
        auto operator()(A1 a1, A2 a2) const { return mLambda(a1, a2); }
    ...
    public:
        using Base = detail::AnyDelegateImpl<IDelegate2R<A1, A2, R>, AnyDelegate2R<A1, A2, R>,
            sizeof(Delegate2R<detail::DummyClassForDelegate, A1, A2, R>)>;
